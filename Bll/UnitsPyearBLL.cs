    ...
    public  class UnitsPyearBLL
    {
        ...
        public bool Add(Common com)
        {
            ...
            using (var trans = DbHelper.BeginTransaction())
            {
                try
                {
                    result = dal.DeleteALL("O32年保证率计算结果表", trans);
                    if (result)
                    {
                        for (int j = 1; j < com.Units_Numb + 2; j++)//根据计算单元编号 依次输出计算结果
                        {
                            ...
                            if (j == com.Units_Numb)
                            {
                                ...
                                Field = "综合平均历时保证率";
                                strField.Add(Field);
                                Value = $"'{string.Format("{0:P}", com.unitsum_Pyear)}'";
                                strValues.Add(Value);
                                for (int ii = 1; ii < com.Users; ii++)
                                {
                                    Field = com.Users_Name[ii] + "历时保证率";
                                    strField.Add(Field);
                                    Value = $"'{string.Format("{0:P}", com.unitsum_user_Pyear[ii])}'";
                                    strValues.Add(Value);
                                }
                            ...
                            else if (j == com.Units_Numb + 1)
                            {
                                ...
                                Field = "综合平均历时保证率";
                                strField.Add(Field);
                                Value = $"'{string.Format("{0:P}", com.SJLT_Pyear)}'";
                                strValues.Add(Value);
                                for (int ii = 1; ii < com.Users; ii++)
                                {
                                    Field = com.Users_Name[ii] + "历时保证率";
                                    strField.Add(Field);
                                    Value = $"'{string.Format("{0:P}", com.SJLT_users_Pyear[ii])}'";
                                    strValues.Add(Value);
                                }
                            }
                            else if (j == com.Units_Numb + 2)
                            {
                                ...
                                Field = "综合平均历时保证率";
                                strField.Add(Field);
                                Value = $"'{string.Format("{0:P}", com.guanqu_Pyear)}'";
                                strValues.Add(Value);
                                for (int ii = 1; ii < com.Users; ii++)
                                {
                                    Field = com.Users_Name[ii] + "历时保证率";
                                    strField.Add(Field);
                                    Value = $"'{string.Format("{0:P}", com.guanqu_user_Pyear[ii])}'";
                                    strValues.Add(Value);
                                }
                            }
                            else
                            {
                                ...
                                Field = "综合平均历时保证率";
                                strField.Add(Field);
                                Value = $"'{string.Format("{0:P}", com.units_waterPyear[j])}'";
                                strValues.Add(Value);
                                for (int ii = 1; ii < com.Users; ii++)
                                {
                                    Field = com.Users_Name[ii] + "历时保证率";
                                    strField.Add(Field);
                                    Value = $"'{string.Format("{0:P}", com.unitsusers_waterPyear[j, ii])}'";
                                    strValues.Add(Value);
                                }
                            }
